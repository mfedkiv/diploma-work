                    ...
                    <ModalBody>
                        ...
                        {!result.error && (
                            <>
                                ...
                                <Text mb={1}>According to the data
                                    obtained, <b>{result.pneumonia ? 'signs of pneumonia were detected' : 'no signs of pneumonia were detected'}</b>.</Text>
                                {result.pneumonia &&
                                    <Text>It is recommended to consult a doctor or medical institution for consultation
                                        and treatment immediately.</Text>}
                            </>
                        )}
                    </ModalBody>
